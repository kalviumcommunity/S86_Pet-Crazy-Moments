    ...
    return (
        <section id="about" className="py-16 px-6 pt-20 bg-white">
            ...
            <div className="flex flex-wrap gap-6 justify-center mt-12">
                {/* Video Section */}
                <div
                    className="relative bg-gray-700 h-80 w-80 flex justify-center items-center rounded-2xl group cursor-pointer transition duration-300 hover:shadow-xl"
                    onClick={() => navigate('/video')}
                >
                    <img src={videoImg} className="h-56 w-60 transition duration-300 group-hover:opacity-30" alt="Video" />
                ...
                >
                    <img src={imageImg} className="h-60 w-60 transition duration-300 group-hover:opacity-30" alt="Image" />
                    <div className="absolute opacity-0 group-hover:opacity-100 text-white text-center p-4 transition duration-300">
